		...
		<div class="container">
			<div class="main-content">
				<div class="banner-box">
					<img alt="" src="../../assets/img/profile/background.svg">
					<div class="setting">
				...
				<div class="profile-box flex-between">
					<div class="data-left">
						<div class="photo-box"><img alt="頭像"></div>
						<div class="content-box">
							<div class="username">
								<h1>{{ userName }}</h1>
							</div>
							<div class="slogan-box flex-center">
								<span class="slogan">你好，世界</span> <!-- <button class="edit">
					...
					<div class="countbar">
						<button class="fans-button">追蹤：555</button>
						<div class="fan-list">
							<div class="fan-list-container">
								<h2 class="fan-list-title">追蹤列表</h2>
								<ul class="fan-list-items">
									<li class="fan-list-item"><img alt="粉絲頭像" class="fan-avatar"> <span class="fan-name">{{ fan.name }}</span></li>
								</ul>
							</div>
						</div><button class="fans-button">粉絲：222</button>
						<div class="fan-list">
							<div class="fan-list-container">
						...
						</div><button class="fans-button">訂閱：123</button>
						<div class="fan-list">
							<div class="fan-list-container">
				...
				<div class="nav flex-between" style="margin-left: 2em">
					<button class="nav-item">文章</button> <button class="nav-item">動態</button> <button class="nav-item">收藏</button>
				</div>
				<div>
					<div class="article-box flex-start">
						<div class="img-box"><img alt="文章縮圖" src="../../assets/img/profile/article_img.svg"></div>
						<div class="article-content">
							...
							<div class="info-box flex-between">
								<div class="author-info flex-start">
									<div class="memoji-box flex-center"><img alt="" src="../../assets/img/profile/memoji.svg"></div>
									<div class="author">
										<div class="name">
											Pavel Gvay
										</div>
	...
	.edit-container {
	 width: 600px;
	 margin: 0 auto; /* 添加此行，使用margin: 0 auto; 將內容水平置中 */
	   padding: 20px;
	   display: flex; /* 添加此行，使用flex布局 */
	   flex-direction: column; /* 添加此行，使內容垂直方向上居中 */
	   align-items: center; /* 添加此行，使內容水平方向上居中 */
	}
